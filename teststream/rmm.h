...
#define insert_batch 8 //insertion batch size
#define N_learner 8 //inf batch size
#define Lev1_Width 4
...
void op_tree(int insert_signal,int *insert_ind,float *init_priority, int update_signal, hls::stream<ap_axiu<32,0,0,0>> &pn_in,int sample_signal,int *ind_o);
}
