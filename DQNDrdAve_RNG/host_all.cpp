...
int main(int argc, char ** argv){
    ...
    // ===================and Replay sampling: (insert=1 only needed once at first. In all later insertion, use insert_signal_in = 2;)
    insert_signal_in = 1;
    update_signal=0;
    sample_signal = 0;
    load_seed = 0;
    ...
    krnl_tree.setArg(6, load_seed);
    krnl_tree.setArg(7, out_buf);
    ...
    krnl_tree2.setArg(6, load_seed);
    krnl_tree2.setArg(7, out_buf);
    ...
    cl::Kernel krnl_tree_samp(program, "Top_tree", &err);
    insert_signal_in = 0;
    update_signal=0;
    sample_signal = 1;
    load_seed = 0;
    ...
    printf("====================================================================================\n");
    printf("\n =================Tree Sampling test without setting seed========================:\n");
    printf("====================================================================================\n");

    krnl_tree_samp.setArg(0, insert_signal_in);
    krnl_tree_samp.setArg(1, insind_buf);
    krnl_tree_samp.setArg(2, inpn_buf);
    krnl_tree_samp.setArg(3, update_signal);
    krnl_tree_samp.setArg(5, sample_signal);
    krnl_tree_samp.setArg(6, load_seed);
    krnl_tree_samp.setArg(7, out_buf);
    q.enqueueMigrateMemObjects({insind_buf,inpn_buf}, 0);
    q.finish();
    q.enqueueTask(krnl_tree_samp);
    q.finish();
    q.enqueueMigrateMemObjects({out_buf}, CL_MIGRATE_MEM_OBJECT_HOST);
    q.finish();
    // printf("===============================================\n");
